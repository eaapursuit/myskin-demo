  ...
  return (
    <div className="bg-chocolate h-full flex items-center justify-center px-16 ">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center px-4 py-2 bg-[#FCE4D8] text-[#472816] text-sm font-medium rounded-full shadow-sm mb-8 font-sans">
                Our Mission
              </div>
              <div className="bg-[#F8F6F6] rounded-3xl p-12 shadow-2xl">
                <p className="text-2xl text-[#472816] leading-relaxed font-medium font-sans">
